...
void print_roi_stats(uint32_t cpu, CACHE *cache)
{
	...
	cout << "  real: " << setw(10) << cache->pf_real << "  PQ to cache: " << setw(10) << cache->PQ.TO_CACHE << endl;
	cout << "  RQ to cache: " << setw(10) << cache->RQ.TO_CACHE << "  WQ to cache: " << setw(10) << cache->WQ.TO_CACHE << endl;
